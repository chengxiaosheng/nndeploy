...
#ifndef _NNDEPLOY_DEVICE_CUDA_CUDA_UTIL_H_
#define _NNDEPLOY_DEVICE_CUDA_CUDA_UTIL_H_
...
inline size_t cudaGetDeviceMaxXDimPerGrid(int d) {
  int dim = 0;
  NNDEPLOY_CUDA_CHECK(cudaDeviceGetAttribute(&dim, cudaDevAttrMaxGridDimX, d));
  return dim;
}
...
#endif /* _NNDEPLOY_DEVICE_CUDA_CUDA_UTIL_H_ */
